    ...
    <div class="auto-container">
        <div class="row clearfix">
            <section class="page-title">
                <div class="auto-container">
                    <h1 class="page-title_heading">{{ $category->name }}</h1>
                </div>
            </section>
            ...
            @if ($posts->isNotEmpty())
                @foreach ($posts as $post)
                    ...
                    <div class="gallery-block_one col-lg-4 col-md-6 col-sm-12 mb-4">
                        <div class="gallery-block_one-inner wow fadeIn animated" data-wow-delay="0ms" data-wow-duration="1500ms"
                            ...
                            <div class="gallery-block_one-content">
                                ...
                                <div class="gallery-block_one-title">{{ $category->name }}</div>
            ...
            @else
                <div class="col-12 text-center">
                    <p class="text-white">{{ __('Không có bài viết nào trong danh mục này!') }}</p>
                </div>
            @endif
        </div>
    </div>
